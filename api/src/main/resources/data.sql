...
INSERT INTO vacancies (position_job, period, work_model, requirements, contract_type, salary, location, opening_justification, area, fk_manager) VALUES
    ...
    ('Designer UX', 'Integral', 'HYBRID', 'Figma, UX Research', 'INTERNSHIP', 2000.00, 'Belo Horizonte', 'Novo projeto', 'UX', 3);
